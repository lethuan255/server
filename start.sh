...
#wait
git clone https://github.com/lethuan255/tasks.git $FOLDER_APPS_PATH/tasks
...
#wait
git clone https://github.com/lethuan255/spreed.git $FOLDER_APPS_PATH/spreed
cd $FOLDER_APPS_PATH/spreed
make dev-setup
make build-js

#wait
git clone https://github.com/lethuan255/calendar.git $FOLDER_APPS_PATH/calendar
cd $FOLDER_APPS_PATH/calendar
make dev-setup
make build-js

#wait
git clone https://github.com/lethuan255/deck.git $FOLDER_APPS_PATH/deck
cd $FOLDER_APPS_PATH/deck
make install-deps
make build

#wait
git clone https://github.com/lethuan255/richdocuments.git $FOLDER_APPS_PATH/richdocuments
